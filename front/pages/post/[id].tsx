...
const PostPage = () => {
	const { title, createdAt, Category, thumbnail, body } = dummyPost;

	return (
		<Container>
			<h1>{title}</h1>
			<DateP>{createdAt}</DateP>
			<Categories categories={Category} aflg={false} />
			{thumbnail && <img src={thumbnail} />}
			<div className="bodyContainer">
				<PostBody setTitle={false} body={body} />
			</div>
		</Container>
	);
};
